...
use App\Models\MarcaCauchoIndustrial;
class CauchoIndustrialMarcaController extends Controller
{
    /**
    ...
    public function index() {
        ...
        return view('CauchoIndustrial.Marcas.ListarMarcas');
    }
    ...
    public function UpdateMarca(Request $request){
        if($request->ajax()){
            ...
            $marca = MarcaCauchoIndustrial::where("id",$id)->first();
    ...
    public function ListadoMarca(Request $request){
        if($request->ajax()){
            ...
            $marca = MarcaCauchoIndustrial::all();
            if($marca != null){
