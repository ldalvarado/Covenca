...
use App\Models\MedidaCamara;
class CamaraMedidaController extends Controller
{
    /**
    ...
    public function index() {
        ...
        return view('Camara.Medidas.ListarMedida');
    }
    ...
    public function UpdateMedida(Request $request){
        if($request->ajax()){
            ...
            $Medida = MedidaCamara::where("id",$id)->first();
