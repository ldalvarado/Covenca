...
class NeumaticosMedidaController extends Controller
{
    /**
    ...
    public function index() {
        ...
        return view('neumaticos.Medidas.ListarMedida');
    }
    ...
    public function UpdateMedida(Request $request){
        if($request->ajax()){
            ...
            $Medida = MedidaCaucho::where("id",$id)->first();
