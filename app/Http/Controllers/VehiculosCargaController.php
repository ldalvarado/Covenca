...
class VehiculosCargaController extends Controller
{
    /**
    ...
    public function index() {
        ...
        return view('Vehiculos.Carga.ListarCarga');
    }
    public function CreateCarga(Request $request){
        $user = Auth::user();
    ...
    public function UpdateCarga(Request $request){
        if($request->ajax()){
            ...
            $Carga = CargaVehiculo::where("id",$id)->first();
            $Carga -> descripcion = $request -> descripcion;
            $Carga -> activo = $request -> activo;
            if($Carga != null){
                $Carga->save();
    ...
    public function DeleteCarga(Request $request){
        if($request->ajax()){
            $id = $request -> id;
            $user = Auth::user();
    ...
    public function GetCarga(Request $request){
        if($request->ajax()){
            ...
            if($Carga != null){
                ...
                return response()->json(["success"=>true,"data"=>$Carga,]);
            }
    ...
    public function ListadoCarga(Request $request){
        if($request->ajax()){
         
            $user = Auth::user();
            
            $Carga = CargaVehiculo::all();
            if($Carga != null){
