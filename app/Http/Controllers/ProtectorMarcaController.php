...
class ProtectorMarcaController extends Controller
{
    /**
    ...
    public function index() {
        ...
        return view('protector.Marcas.ListarMarcas');
    }
    ...
    public function UpdateMarca(Request $request){
        if($request->ajax()){
            ...
            $marca = MarcaProtector::where("id",$id)->first();
