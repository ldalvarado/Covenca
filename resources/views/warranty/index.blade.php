                ...
                <div class="card w-100">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <div class="p-2 table-responsive" style="overflow:auto;">
                                <table class="table table-bordered table-striped" id="tableGarantias">
...
<script>
     var table = $('#tableGarantias').DataTable({
