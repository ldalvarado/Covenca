                     ...
                     <div class="card">
                       ...
                       <div id="collapseOne" class="collapse show" role="tabpanel" aria-labelledby="headingTwo">
                         <div class="card-block p-2">
                           ...
                           @if ($reclamo->DiagramaCaucho != null & $reclamo->InfoProductoAnalisis->idProducto != 5)
                           <section class="p-0">
                           <div class="p-0">
                               ...
                               <div class="form-layout form-layout-1 p-1">
                                       <div class="d-flex-column align-items-center justify-content-around ht-auto bd pd-x-20 pd-y-10"><!--Vehículo-->
                                          ...
                                          <dic class="row pd-y-20 pd-md-y-0">
                                            ...
                                            @if($reclamo->InfoProductoAnalisis->idProducto ==3)
                                            <div class="col-md-12">
                                            @else
                                            <div class="col-md-6">
                                            @endif
				                             	<div class="pull-left" id="containerDiagrama">
				                             		

				                             			<?php echo $reclamo->DiagramaCaucho->contenido ?>
                                  ...
                                  <div class="form-layout form-layout-1 p-2">
                                          ...
                                          <div class="d-flex-column align-items-center justify-content-around ht-auto bd pd-x-20 pd-y-10"><!--Vehículo-->
                                              ...
                                              <div class="row pd-y-20 pd-md-y-0">
                                                  ...
                                                  @if($ReclamoCondicion->condicion != null)
                                                  <div class="col-md-12"><!---->
                                          ...
                                          <div class="d-flex-column row justify-content-around ht-auto bd pd-x-20 pd-y-10" style="margin:0 !important">
                                          ...
                                          <div class="pull-left text-left col-md-6">
                                                ...
                                                @if ($reclamo->ImagenReclamoSucursal != null)
                                                    ...
                                                    @if ($reclamo->ImagenReclamoSucursal->imagen64 != null )
				                            		<address>
                                          ...
                                          <div class="form-layout form-layout-1 p-0">
                                            ...
                                            <div class="d-flex-column justify-content-around ht-auto bd pd-x-20 pd-y-10"><!--Vehículo-->
                                              ...
                                              <div class="pull-left text-left  col-md-6">
				                            	...
				                            	<div class="pull-left text-left col-md-6">
                                                @if ($reclamo->ImagenReclamo)
                                                @if($reclamo->ImagenReclamo->imagen64 != null)
				                            		<address>
                                                    <h4 class="tx-info">Imagen del Producto</h4>
				                            	...
				                            	<div class="pull-left text-left">
                                                    ...
                                                    <h5 class="font-bold"> <span>{{$reclamo->InfoProductoAnalisis->getProducto->descripcion}}</span></h5>
				                            			<p class="text-muted m-l-5">
				                            				...
				                            				<br/>
                                                            @endif
                                                            @if($reclamo->InfoProductoAnalisis->getProducto->DatosCampos->boleta != null &$reclamo->InfoProductoAnalisis->boleta != null)
                                        ...
                                        <div class="d-flex-column align-items-center justify-content-around ht-auto bd pd-x-20 pd-y-10"><!--Vehículo-->
                                          <h4 class="tx-info">Crédito</h4>
                                            <div class="form-layout form-layout-1 p-0">
                                              ...
                                              <div class="row pd-y-20 pd-md-y-0">
				                            	<div class="pull-left text-left col-md-6">
                                                <h5>{{$reclamo->CreditoReclamo->codigo}}</h4>
                                                <address>
                            ...
                            <div class="card-body pb-0">
                                <div class="container-fluid overflow-auto">
                                    ...
                                    <div id="Planificacion" class="row flex-row flex-nowrap text-center text-lg">
                                            ...
                                            @if ( $reclamo->getEspecialReclamo == null &&  $reclamo->getEspecial == null)

                                            <div class="col-auto " style="margin-top: auto;margin-bottom: auto;">
                                                <div class="columna">
                                                <a  href="{{ route('PDFreclamo', [$reclamo->id]) }}" target="_blank" class="btn btn-info info-box-icon elevation-3">
                                    ...
                                    @foreach($reclamo->ListEstadosReclamo as $estadoReclam)
                                                    ...
                                                    @if ($estadoReclam->activo || $estadoReclam->idReclamo == 6)
                                                        <div class="col-auto " data-toggle="tooltip" data-placement="top" title="@Plan.fecha_inicial.ToString("dd/MM/yyyy HH:mm") a @Plan.fecha_final.ToString("dd/MM/yyyy HH:mm")">
                                                    ...
                                                    @else
                                                        ...
                                                        @if($estadoReclam->getEstado->id == 1 && $estadoReclam->getEstado->activo == "false")
                                                            <div class="col-auto " style="margin-top: auto;margin-bottom: auto;">
                                                                <div class="columna">
                                                                    <a  href="{{ route('PDFGuia', [$reclamo->GuiaReclamo->guia->codigo]) }}" target="_blank" class="btn btn-info info-box-icon elevation-3">
                                                                        <i class="far fa-file-pdf"></i>
                                                                        <span class="textoBoton ">PDF</span> 
                                                                    </a> 
                                                                </div>
                                                        ...
                                                        @if($estadoReclam->getEstado->id == 4)
                                                            <div class="col-auto " style="margin-top: auto;margin-bottom: auto;">
                                                                <div class="columna">
                                                                    <a  href="{{ route('analisisPDF', [$reclamo->id]) }}" target="_blank" class="btn btn-info info-box-icon elevation-3">
                                                                        <i class="far fa-file-pdf"></i>
                                                                        <span class="textoBoton ">PDF</span> 
                                                                    </a> 
                                                                </div>
                                                        ...
                                                        @endif
                                                        @if($estadoReclam->getEstado->id == 5 & $reclamo -> PdfReclamo != null)
                                                            <div class="col-auto " style="margin-top: auto;margin-bottom: auto;">
                                                                <div class="columna">
                                                                    <a  href="{{ route('getPdfReclamo', [$reclamo->id]) }}" target="_blank" class="btn btn-info info-box-icon elevation-3">
                                                                        <i class="far fa-file-pdf"></i>
                                                                        <span class="textoBoton ">PDF</span> 
                                                                    </a> 
                                                                </div>
...
<script>
   ...
   window.onload = function() {
    ...
    var posicion = @if($reclamo->DiagramaCaucho!= null)
                    "{{$reclamo->DiagramaCaucho->posicion}}";
                    @else
                    "error";
                    @endif
    ...
    @if($reclamo->InfoProductoAnalisis->idProducto == 3)
        ...
        $("#Opcion_"+posicion).prop('checked',true);
    @endif
    $('input[value="'+posicion+'"]').prop('checked',true);
    $($('input[value="'+posicion+'"]')[0].parentElement).find('img').attr('src',"{{url('/ui/assets/images/icon/tire-danger.png')}}");
    console.log();
  };
