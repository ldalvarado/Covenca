...
<head>
    ...
    </style><script async src="https://cdn.ampproject.org/v0.js"></script><style amp-custom>
        .es-desk-hidden {
            display: none;
            float: left;
            overflow: hidden;
            ...
            <tr class="gmail-fix" height="0">
                <td>
                    <table width="600" cellspacing="0" cellpadding="0" border="0" align="center">
                        <tr>
                            <td style="line-height: 1px;min-width: 600px" height="70">
            ...
            <tr>
                <td valign="top">
                                                ...
                                                <tr>
                                                    <td width="580" valign="top" align="center">
                                                        <table width="100%" cellspacing="0" cellpadding="0"
                                                            role="presentation">
                                                            <tr>
                                                                <td class="es-p25t es-p25b es-p10r es-p10l" 
                                                                    align="center" style="font-size: 0px">
                                                                    <img
                                                                         src="{{ $message->embed(public_path() . '/img/dobermann-logoWeb.png') }}"
                                                                        alt style="display: block" width="350"
                                                                        height="62"></img>
                                                                </td>
                                                            </tr>
                                                        </table>
                    ...
                    <table class="es-content" cellspacing="0" cellpadding="0" align="center">
                        <tr>
                            <td style="background-color: #ec6d64" bgcolor="#ec6d64" align="center">
                                            ...
                                            <table width="100%" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td width="600" valign="top" align="center">
                                                        <table
                                                            style="background-color: #ffffff;border-radius: 4px;border-collapse: separate"
                                                            width="100%" cellspacing="0" cellpadding="0"
                                                            bgcolor="#ffffff" role="presentation">
                                                            <tr>
                                                                <td class="es-p35t es-p5b es-p30r es-p30l"
                                                                    align="center">
                                                                    <h1 style="font-size: 36px">Su Garantia ha pasado a:
                                                                    </h1>
                                                                    <p style="font-size: 22px">{{$Estado}}</p>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="es-p5t es-p5b es-p20r es-p20l"
                                                ...
                                                <tr>
                                                    <td width="600" valign="top" align="center">
                                                        <table style="background-color: #ffffff" width="100%"
                                                            ...
                                                            role="presentation">
                                                            <tr>
                                                                <td class="es-m-txt-l es-p20t es-p15b es-p30r es-p30l"
                                                                    bgcolor="#ffffff" align="left">
                                                                    <p>Informacion:</p>
                                                                    <ul>
                                                                  
                                                                        <li>Numero de garantia: {{$Numero}}</li>
                                                                    </ul>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                ...
                                                <tr>
                                                    <td width="540" valign="top" align="center">
                                                        <table width="100%" cellspacing="0" cellpadding="0"
                                                            role="presentation">
                                                            <tr>
                                                                <!--td class="es-p40t es-p40b es-p10r es-p10l"
                                                                    align="center"><span class="es-button-border"
                                                                        style="background: #ec6d64 ;border-color: #ec6d64"><a
                                                                            href class="es-button es-button-1"
                                                                            target="_blank"
                                                                            style="border-width: 15px 25px;background: #ec6d64 ;border-color: #ec6d64">Ver
                                                                            Estado de Su Garantia</a></span></td-->
                                                            </tr>
                                                        </table>
                                                    </td>
                                                </tr>
                                        ...
                                        <td align="left">
                                            <table width="100%" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td width="600" valign="top" align="center">
                                                        <table
                                                            style="border-radius: 4px;border-collapse: separate;background-color: #111111"
                                                            width="100%" cellspacing="0" cellpadding="0"
                                                            bgcolor="#111111" role="presentation">
                                                            <tr>
                                                                <td class="es-m-txt-l es-p35t es-p30r es-p30l"
                                                                    bgcolor="#111111" align="left">
                                                                    <h2 style="color: #ffffff">Covencaucho C.A.</h2>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="es-p20t es-p30r es-p30l es-m-txt-l"
                                                                    align="left">
                                                                    <p><br></p>
                                                                </td>
                                                            </tr>
                                                ...
                                                <tr>
                                                    <td width="600" valign="top" align="center">
                                                        <table width="100%" cellspacing="0" cellpadding="0"
                                                            role="presentation">
                                                            <tr>
                                                                <td class="es-p10t es-p20b es-p20r es-p20l"
                                                            ...
                                                            <tr>
                                                                <td class="es-infoblock made_with" align="center"
                                                                    style="font-size:0"><a target="_blank"
                                                                        ...
                                                                        <amp-img
                                                                            src="https://uvalbi.stripocdn.email/content/guids/CABINET_9df86e5b6c53dd0319931e2447ed854b/images/64951510234941531.png"
                                                                            alt width="125" height="56"></amp-img>
                                                                    </a></td>
                                                            </tr>
                                                        </table>
                                                    </td>
