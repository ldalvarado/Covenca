    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
                <h4 class="modal-title te" id="tituloModal">Crear Rechazo</h4>
                    ...
                    <div class="container-fluid pt-2">
                        ...
                        <div class="col-4">
                                <div id="medidas" class="parsley-input">
                                    <label>Código: <span class="tx-danger"></span></label>
                                    <input type="text" id="idCodigoC" name="descripcion" class="form-control wd-250" placeholder="Código" data-parsley-class-handler="#medidas">
                                </div>
                            </div>
<br/>
                            <div class="col-12">
                                 <label>Zona: <span class="tx-danger"></span></label>

                                <select class="form-control" id="selectzona" data-live-search="true" data-placeholder="Seleccione zona">
                                    <option label="Seleccione zona"></option>
                        ...
                        <input type="hidden" id="idusu" name="idUser" value="1" class="form-control wd-250" placeholder="Descripción">
                            ...
                            <div class = "col-12">
                            <label>procede: <span class="tx-danger"></span></label> </div>
</div>
                        <div class = "row">
                            <div class="col-6">
...
<script>
    let select = document.getElementById('selectzona');
    $.ajax({
    ...
    function crear(){
        ...
        if (va) {
            ...
            var settings = {
                ...
                "url": '<?php echo route('CreateRechazo')?>',
                "method": "POST",
                data: {
                    "_token": $("meta[name='csrf-token']").attr("content"),
