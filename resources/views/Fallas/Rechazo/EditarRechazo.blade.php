    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
                <h4 class="modal-title te" id="tituloModal">Editar Rechazo</h4>
                ...
                <form role="form" class="parsley-style-1" id="formeditar">
                    ...
                    <div class="col-4">
                                <div id="medidas" class="parsley-input">
                                    ...
                                    <input type="text" id="idCodigoE" name="descripcion" class="form-control wd-250" placeholder="Código" data-parsley-class-handler="#medidas">
                                </div>
                            </div>
                            <div class="col-12">
...
<script>
        ...
        function editar_ancho(id){
            ...
            $.ajax(settings).done(function (data) {
                let response = data.data;
                    ...
                    selectedit.value = response.idZona;
    ...
    function actualizar(){
        ...
        if (va) {
            ...
            var settings = {
                "url": '<?php echo route('UpdateRechazo')?>' ,
                "method": "PUT",
                data: {
                    "_token": $("meta[name='csrf-token']").attr("content"),
                    "id":id,
                    ...
                    'activo':activos,
                    "idZona":selectedit.value,
                    "procede": resp_yes,
                    "codigo" : $('#idCodigoE').val(),    
                    },
            };
