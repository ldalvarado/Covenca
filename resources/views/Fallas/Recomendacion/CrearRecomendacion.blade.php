    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
                <h4 class="modal-title te" id="tituloModal">Crear Recomendacion</h4>
                        ...
                        <input type="hidden" id="idusu" name="idUser" value="1" class="form-control wd-250" placeholder="Descripción">
                            <div class="col-4">
                                <div id="medidas" class="parsley-input">
                                    ...
                                    <textarea type="text" id="iddescricion" name="descripcion" class="form-control wd-250" placeholder="Descripción" data-parsley-class-handler="#medidas"></textarea>
                                </div>
                            </div>
    ...
    function crear(){
        ...
        if (va) {
            ...
            var settings = {
                ...
                "url": '<?php echo route('CreateRecomendacion')?>',
                "method": "POST",
                data: {
