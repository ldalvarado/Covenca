    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
                <h4 class="modal-title te" id="tituloModal">Editar Marca</h4>
...
<script>
    ...
    $.ajax({
                ...
                url: '<?php echo route('VehiculoListadoMarca') ?>',
                type: "POST",                
                data: {
    ...
    var validar_formEditar = $('#formeditar').validate({
        ...
        function editar_ancho(id){
            var settings = {
                "url": '<?php echo route('GetModeloVehiculo')?>',
                "method": "POST",
            ...
            $.ajax(settings).done(function (data) {
                let response = data.data;
                    ...
                    selectedit.value = response.idMarca;
    ...
    function actualizar(){
        ...
        if (va) {
            var settings = {
                "url": '<?php echo route('UpdateModeloVehiculo')?>' ,
                "method": "PUT",
                data: {
                    "_token": $("meta[name='csrf-token']").attr("content"),
                    "id":id,
