...
@section('contenido')
    ...
    <div class="br-pagebody mg-t-5 pd-30">
      ...
      @include('Vehiculos.Modelo.CrearModelo')
      @include('Vehiculos.Modelo.EditarModelo')
      <script>
           $(document).ready(function(){
            ActivateNavLink("nav-link_vmo");
            });
                var table = $('#tableModelo').DataTable({
                ajax: {
                url: '<?php echo route('ListadoModeloVehiculo')?>',
                type: "POST",                
                data: {
    ...
    function eliminar_Modelo(id){
            ...
            var settings = {
                "url": '<?php echo route('DeleteModeloVehiculo')?>',
                "method": "DELETE",
