    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
                <h4 class="modal-title te" id="tituloModal">Crear Tipo</h4>
                    ...
                    <div class="container-fluid pt-2">
                        <div class = "row" style = "padding-bottom:20px">
                            <div class="col-12">
                                ...
                                <select class="form-control" id="selectEje" data-live-search="true" data-placeholder="Seleccione Eje">
...
<script>
    let select = document.getElementById('selectEje');
    $.ajax({
    ...
    function crear(){
        ...
        if (va) {
            var settings = {
                ...
                "url": '<?php echo route('CreateTipoVehiculo')?>',
                "method": "POST",
                data: {
                    "_token": $("meta[name='csrf-token']").attr("content"),
