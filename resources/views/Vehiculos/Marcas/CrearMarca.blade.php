    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
                <h4 class="modal-title te" id="tituloModal">Crear Marca</h4>
...
<script>
    ...
    var validar_Marca = $('#formCrear').validate({
                rules: {
                    descripcion: {
                        required: true,
                    },
    ...
    function crear(){
        ...
        if (va) {
            var settings = {
                ...
                "url": '<?php echo route('VehiculoCreateMarca')?>',
                "method": "POST",
                data: {
