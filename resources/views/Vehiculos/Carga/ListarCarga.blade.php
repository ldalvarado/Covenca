...
@section('contenido')
    ...
    <div class="br-pagebody mg-t-5 pd-30">
                  ...
                  <div class="card-header pt-3 pb-3">
                      <div class="row justify-content-center">
                          <div class="col align-self-center">
                              <h4 class=" text-bold text-center mb-0">Listado de Carga</h4>
                          </div>
                          <div class="col-auto align-self-center">
                              <div class="btn-group" style="">
                                  <a id="btnAddOrder" class="btn btn-primary btn-lg text-lg text-bold text-right" href="#"  data-toggle="modal" data-target="#modal_crear"><i class="fa fa-plus"> <span class="textoBoton"> Carga</span></i></a>
                              </div>
                          </div>
                      </div>
                  </div>
                  <div class="card-body">
                      <div class="form-group">
                          <div class="p-2 table-responsive">
                              <table class="table table-bordered table-striped" id="tableCarga">
      ...
      @include('Vehiculos.Carga.CrearCarga')
      @include('Vehiculos.Carga.EditarCarga')
      <script>
          $(document).ready(function(){
            ActivateNavLink("nav-link_vc");
            });
                var table = $('#tableCarga').DataTable({
                ajax: {
                url: '<?php echo route('VehiculoListadoCarga') ?>',
                type: "POST",                
                data: {
            ...
            <!--{ "data": "activo", "defaultContent": "" },-->
            {
                "render": function (data, type, row) {
                    ...
                    <div class="text-center" style="display: inline-flex;">
                        ...
                        <a class="btn btn-danger  ver btn-md"  onclick="eliminar_Carga(\'` + row.id + `\')" data-toggle="modal" data-target="#"><i class="fa fa-trash-alt"style="color: #fafafa;"></i></a>
    ...
    function eliminar_Carga(id){
            ...
            var settings = {
                "url": '<?php echo route('VehiculoDeleteCarga') ?>',
                "method": "DELETE",
