    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
                <h4 class="modal-title te" id="tituloModal">Editar Carga</h4>
                        ...
                        <input type="hidden" id="idEditacodigo" name="idcodigo" value="" class="form-control wd-250" placeholder="Descripción">
                            <div class="col-4">
                                <div id="medidas" class="parsley-input">
                                    <label>Carga: <span class="tx-danger"></span></label>
...
<script>
    ...
    var validar_formEditar = $('#formeditar').validate({
        ...
        function editar_ancho(id){
            var settings = {
                "url": '<?php echo route('VehiculoGetCarga') ?>',
                "method": "POST",
    ...
    function actualizar(){
        ...
        if (va) {
            var settings = {
                "url": '<?php echo route('VehiculoUpdateCarga') ?>' ,
                "method": "PUT",
                data: {
                    "_token": $("meta[name='csrf-token']").attr("content"),
                    "id":id,
