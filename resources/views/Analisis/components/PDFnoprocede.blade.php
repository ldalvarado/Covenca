...
?>
  ...
  <table width="100%" class="small" cellpadding="3">
	...
	<table width="100%" class="small" cellpadding="3">
		<thead>
			<tr style="text-align: left !important;">
				<th colspan="2" class="font-weight-bold text-uppercase" style="text-transform: uppercase;">Datos del Distribuidor</th>
			</tr>
		</thead>
		<tbody style="border: 1px solid black">
			<tr>
	...
	<table width="100%" class="small" cellpadding="3">
		...
		<tbody style="border: 1px solid black">
			<tr>
			<td width="50%" style="vertical-align: top;">
			<small style="font-size: 12px; vertical-align: top;">
				...
				@if ($reclamo->ImagenReclamo != null)
					...
					<div style="position: absotute;vertical-align: top; ">
								    <b class="font-weight-bold">Decisión:</b>  <small style="text-transform: uppercase;text-decoration: underline;">No procede</small>
	...
	<table width="100%" class="small" cellpadding="3">
		<thead>
			<tr style="text-align: left !important;">
				<th class="font-weight-bold text-uppercase" style="text-transform: uppercase; text-align: left;">Recomendaciones para el cliente</th>
			</tr>
		</thead>
		<tbody >
			<tr>
