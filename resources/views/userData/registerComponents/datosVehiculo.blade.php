...
<div class="col-12">   <label class="form-control-label" for="">¿Has usado cauchos renovados alguna vez?</</label><span class="tx-danger">*</span>
    ...
    <div class="form-check">
        <label class="d-flex justify-content-start rdiobox ">
                <input  type="radio" name="renovado" id="input_renovados_no"  >
                <span>No</span></label>  
        </div>
    </div>
    ...
    <div class="col-12">   <label class="form-control-label" for="">¿Qué tipo de Remolques operativos posee?</</label><span class="tx-danger">*</span>
        ...
        <div class="form-check">
            <label class="d-flex justify-content-start ">
                ...
                <input  onchange="activateTextInput('check4x0','input_4x0')" id="check4x0" type="checkbox" name="tipo_cliente" id="check4x0"  >
        ...
        <div class="form-check">
            ...
            <span>6x0 (3 Ejes) </span></label> 
                    <input onchange="activateTextInput('check6x0','input_6x0')" id="check6x0" type="checkbox" name="tipo_cliente" id="check6x0"  >
        ...
        <div class="col-12 col-md-6">
            ...
            <label class="d-flex justify-content-start ">
                ...
                <input onchange="activateTextInput('check8x0','input_8x0')" id="check8x0" type="checkbox" name="tipo_cliente" id="check8x0"   >
...
<script>
    ...
    $(document).ready(function(){
        ...
        document.getElementById('input_renovados').checked = cliente.renovado != null;

        if(vehiculo != null){
            let medidas = ["4x2","6x2","6x4","2x0","4x0","6x0","8x0"];
            for(let i = 0 ; i < medidas.length;i++){
                if(vehiculo[medidas[i]] != null){
                    document.getElementById('check'+medidas[i]).checked = true;
                    document.getElementById('input_'+medidas[i]).disabled = false;

                    document.getElementById('input_'+medidas[i]).value = vehiculo[medidas[i]];
