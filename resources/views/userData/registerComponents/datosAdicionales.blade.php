...
<script>
    ...
    $(document).ready(function(){
        ...
        let marcasCliente = {!!$marcas_cliente!!};
        let cliente = {!!$cliente!!};
        $("#input_carcasa").val(cliente.carcasa);
        console.log('aveces');
        console.log(marcasCliente);
        for(let i = 0 ; i < marcasCliente.length;i++){
            document.getElementById('marca_'+marcasCliente[i].idMarca).checked = true;
            storeMarca(marcasCliente[i].idMarca,'bueno');
        }
    })
</script>