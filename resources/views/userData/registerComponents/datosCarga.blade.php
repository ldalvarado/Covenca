...
<script>
    $(document).ready(function(){
        ...
        let carga = {!!$carga!!};
        let fecha = {!!$fecha!!};
        $("#input_carga_data").val(cliente.carga);
        $("#input_kmFlota").val(cliente.kmFlota);
        $("#input_perFlota").val(cliente.perFlota);

        if(carga != null){
            document.getElementById("input_liquidos").checked = carga.liquidos==1;
            document.getElementById("input_pasajeros").checked = carga.pasajeros==1;
            document.getElementById("input_agricola").checked = carga.agricola==1;
            document.getElementById("input_alimento").checked = carga.alimento==1;
            document.getElementById("input_construccion").checked = carga.construccion==1;
            document.getElementById("input_electronicos").checked = carga.electronicos==1;
            document.getElementById("input_farmacos").checked = carga.farmacos==1;
            document.getElementById("input_textiles").checked = carga.textiles==1;
        }
        if(fecha != null){
            document.getElementById("input_enero").checked = fecha.enero == 1;
            document.getElementById("input_febrero").checked = fecha.febrero == 1;
            document.getElementById("input_marzo").checked = fecha.marzo == 1;
            document.getElementById("input_abril").checked = fecha.abril == 1;
            document.getElementById("input_mayo").checked = fecha.mayo == 1;
            document.getElementById("input_junio").checked = fecha.junio == 1;
            document.getElementById("input_julio").checked = fecha.julio == 1;
            document.getElementById("input_agosto").checked = fecha.agosto == 1;
            document.getElementById("input_septiembre").checked = fecha.septiembre == 1;
            document.getElementById("input_octubre").checked = fecha.octubre == 1;
            document.getElementById("input_noviembre").checked = fecha.noviembre == 1;
            document.getElementById("input_diciembre").checked = fecha.diciembre == 1;
        }
    });
    function selectAll(){
