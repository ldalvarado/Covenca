...
@section('contenido')
    ...
    <div class="br-pagebody mg-t-5 pd-30">
      ...
      @include('Camara.Medidas.CrearMedida')
      @include('Camara.Medidas.EditarMedida')
      <script>
           $(document).ready(function(){
            ActivateNavLink("nav-link_ame");
            });
                var table = $('#tableMedida').DataTable({
                ajax: {
                url: '<?php echo route('CamaraListadoMedida') ?>',
                type: "POST",                
                data: {
    ...
    function eliminar_Medida(id){
            ...
            var settings = {
                "url": '<?php echo route('CamaraDeleteMedida') ?>',
                "method": "DELETE",
