...
@section('contenido')
    ...
    <div class="br-pagebody mg-t-5 pd-30">
      ...
      @include('protector.Marcas.CrearMarca')
      @include('protector.Marcas.EditarMarca')
      <script>
           $(document).ready(function(){
            ActivateNavLink("nav-link_pm");
            });
                var table = $('#tableMarca').DataTable({
                ajax: {
                url: '<?php echo route('protectorListadoMarca') ?>',
                type: "POST",                
                data: {
    ...
    function eliminar_marca(id){
            ...
            var settings = {
                "url": '<?php echo route('protectorDeleteMarca') ?>',
                "method": "DELETE",
