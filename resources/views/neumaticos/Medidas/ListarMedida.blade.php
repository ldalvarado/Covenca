...
@section('contenido')
    ...
    <div class="br-pagebody mg-t-5 pd-30">
      ...
      @include('neumaticos.Medidas.CrearMedida')
      @include('neumaticos.Medidas.EditarMedida')
      <script>
           $(document).ready(function(){
            ActivateNavLink("nav-link_nm");
            });
                var table = $('#tableMedida').DataTable({
                ajax: {
                url: '<?php echo route('ListadoMedida') ?>',
                type: "POST",                
                data: {
    ...
    function eliminar_Medida(id){
            ...
            var settings = {
                "url": '<?php echo route('DeleteMedida') ?>',
                "method": "DELETE",
