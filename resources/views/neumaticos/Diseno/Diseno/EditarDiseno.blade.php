    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
                <h4 class="modal-title te" id="tituloModal">Editar Diseño</h4>
                        ...
                        <input type="hidden" id="idEditacodigo" name="idcodigo" value="" class="form-control wd-250" placeholder="Descripción">
                            <div class="col-4">
                                <div id="medidas" class="parsley-input">
                                    ...
                                    <input  id="idEditadescripcion" name="descripcion" class="form-control wd-250" placeholder="Descripción" data-parsley-class-handler="#medidas" rows="3">
                                </div>
                            </div>
                        ...
                        <div class = "row">
                            <div class="col-6">
                                ...
                                <label class="d-flex justify-content-center rdiobox ">
                                    <input name="resp_edit" type="radio" id="yes_rb_create" value="yes" checked ><span>Frio</span>
                                </label> 
                            </div>
                            <div class="col-6">
                                <label class="d-flex justify-content-center rdiobox ">
                                    <input name="resp_edit" type="radio"  id="no_rb_create" value="no" ><span>Caliente</span>
...
<script>
            ...
            $.ajax(settings).done(function (data) {
                let response = data.data;
                    ...
                    if(response.procede){
                        ...
                        console.log(data.procede);
                    }else{
                        $("#no_rb_create").prop( "checked", true );
                        console.log(data.procede);
 
                    }
                    selectedit.value = response.idAplicacion;
    ...
    function actualizar(){
        ...
        if (va) {
            ...
            var settings = {
                "url": '<?php echo route('UpdateDiseno')?>' ,
                "method": "PUT",
                data: {
                    "_token": $("meta[name='csrf-token']").attr("content"),
                    "id":id,
