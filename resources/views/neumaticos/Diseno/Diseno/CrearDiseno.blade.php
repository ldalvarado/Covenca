    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
                <h4 class="modal-title te" id="tituloModal">Crear Diseño</h4>
...
<br/>
                            <div class="col-12">
                                 <label>Aplicación: <span class="tx-danger"></span></label>

                                <select class="form-control" id="selectaplicacion" data-live-search="true" data-placeholder="Seleccione aplicacion">
                        ...
                        <input type="hidden" id="idusu" name="idUser" value="1" class="form-control wd-250" placeholder="Descripción">
                            <div class="col-4">
                                <div id="medidas" class="parsley-input">
                                    ...
                                    <input  id="iddescricion" name="descripcion" class="form-control wd-250" placeholder="Descripción" data-parsley-class-handler="#medidas" >
                                </div>
                            ...
                            <div class = "col-12">
                            <label>Tipo: <span class="tx-danger"></span></label> </div>
</div>
                        <div class = "row">
                            <div class="col-6">
                               
                                <label class="d-flex justify-content-center rdiobox ">
                                    <input name="resp_create" type="radio" id="yes_rb" value="yes" checked ><span>Frio</span>
                                </label> 
                            </div>
                            <div class="col-6">
                                <label class="d-flex justify-content-center rdiobox ">
                                    <input name="resp_create" type="radio"  id="no_rb" value="no" ><span>Caliente</span>
...
<script>
    let select = document.getElementById('selectaplicacion');
    $.ajax({
