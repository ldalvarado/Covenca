    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
                <h4 class="modal-title te" id="tituloModal">Crear Profundidad</h4>
                        ...
                        <input type="hidden" id="idusu" name="idUser" value="1" class="form-control wd-250" placeholder="Descripción">
                            <div class="col-4">
                                <div id="medidas" class="parsley-input">
                                    <label>Profundidad: <span class="tx-danger"></span></label>
...
<script>
    ...
    var validar_Profundidad = $('#formCrear').validate({
                rules: {
                    descripcion: {
                        required: true,
                    },
    ...
    function crear(){
        var va = validar_Profundidad.form();
        ...
        if (va) {
            var settings = {
                ...
                "url": '<?php echo route('NeumaticoCreateProfundidad')?>',
                "method": "POST",
                data: {
