    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
                <h4 class="modal-title te" id="tituloModal">Editar Profundidad</h4>
...
<script>
    ...
    var validar_formEditar = $('#formeditar').validate({
        ...
        function editar_Profundidad(id){
            var settings = {
                "url": '<?php echo route('NeumaticoGetProfundidad') ?>',
                "method": "POST",
    ...
    function actualizar(){
        ...
        if (va) {
            var settings = {
                "url": '<?php echo route('NeumaticoUpdateProfundidad') ?>' ,
                "method": "PUT",
                data: {
                    "_token": $("meta[name='csrf-token']").attr("content"),
                    "id":id,
