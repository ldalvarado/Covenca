...
@section('contenido')
    ...
    <div class="br-pagebody mg-t-5 pd-30">
                  ...
                  <div class="card-header pt-3 pb-3">
                      <div class="row justify-content-center">
                          <div class="col align-self-center">
                              <h4 class=" text-bold text-center mb-0">Listado de Disenos</h4>
                          </div>
                          <div class="col-auto align-self-center">
                              <div class="btn-group" style="">
                                  <a id="btnAddOrder" class="btn btn-primary btn-lg text-lg text-bold text-right" href="#"  data-toggle="modal" data-target="#modal_crear"><i class="fa fa-plus"> <span class="textoBoton"> Disenos</span></i></a>
                              </div>
                          </div>
                      </div>
                  </div>
      ...
      @include('neumaticos.Disenos.CrearDiseno')
      @include('neumaticos.Disenos.EditarDiseno')
      <script>
