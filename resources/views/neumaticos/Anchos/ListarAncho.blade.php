...
@section('contenido')
    ...
    <div class="br-pagebody mg-t-5 pd-30">
                  ...
                  <div class="card-body">
                      <div class="form-group">
                          <div class="p-2 table-responsive">
                              <table class="table table-bordered table-striped" id="tableAncho">
      ...
      @include('neumaticos.Anchos.CrearAncho')
      @include('neumaticos.Anchos.EditarAncho')
      <script>
          $(document).ready(function(){
            ActivateNavLink("nav-link_na");
            });
                var table = $('#tableAncho').DataTable({
                ajax: {
            ...
            <!--{ "data": "activo", "defaultContent": "" },-->
            {
                "render": function (data, type, row) {
                    ...
                    <div class="text-center" style="display: inline-flex;">
                        ...
                        <a class="btn btn-danger  ver btn-md"  onclick="eliminar_Ancho(\'` + row.id + `\')" data-toggle="modal" data-target="#"><i class="fa fa-trash-alt"style="color: #fafafa;"></i></a>
    ...
    function eliminar_Ancho(id){

            var settings = {
                "url": '<?php echo route('NeumaticoDeleteAncho') ?>',
                "method": "DELETE",
