...
@section('contenido')
    ...
    <div class="br-pagebody mg-t-5 pd-30">
                  ...
                  <div class="card-header pt-3 pb-3">
                      <div class="row justify-content-center">
                          <div class="col align-self-center">
                              <h4 class=" text-bold text-center mb-0">Listado de Medidas</h4>
                          </div>
                          <div class="col-auto align-self-center">
                              <div class="btn-group" style="">
                                  <a id="btnAddOrder" class="btn btn-primary btn-lg text-lg text-bold text-right" href="#"  data-toggle="modal" data-target="#modal_crear"><i class="fa fa-plus"> <span class="textoBoton"> Medidas</span></i></a>
                              </div>
                          </div>
                      </div>
                  </div>
                  <div class="card-body">
                      <div class="form-group">
                          <div class="p-2 table-responsive">
                              <table class="table table-bordered table-striped" id="tableMedida">
      ...
      @include('CauchoIndustrial.Medidas.CrearMedida')
      @include('CauchoIndustrial.Medidas.EditarMedida')
      <script>
          $(document).ready(function(){
            ActivateNavLink("nav-link_cim");
            });
                var table = $('#tableMedida').DataTable({
                ajax: {
                url: '<?php echo route('CauchoIndustrialListadoMedida') ?>',
                type: "POST",                
                data: {
            ...
            <!--{ "data": "activo", "defaultContent": "" },-->
            {
                "render": function (data, type, row) {
                    ...
                    <div class="text-center" style="display: inline-flex;">
                        ...
                        <a class="btn btn-danger  ver btn-md"  onclick="eliminar_Medida(\'` + row.id + `\')" data-toggle="modal" data-target="#"><i class="fa fa-trash-alt"style="color: #fafafa;"></i></a>
    ...
    function eliminar_Medida(id){
            ...
            var settings = {
                "url": '<?php echo route('CauchoIndustrialDeleteMedida') ?>',
                "method": "DELETE",
