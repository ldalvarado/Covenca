    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
                <h4 class="modal-title te" id="tituloModal">Crear Caucho Industrial</h4>
                        ...
                        <input type="hidden" id="idusu" name="idUser" value="1" class="form-control wd-250" placeholder="Descripción">
                            ...
                            <div class="col-4">
                                <div id="medidas" class="parsley-input">
                                    ...
                                    <input type="text" id="idnomenclatura" name="nomenclatura" class="form-control wd-250" placeholder="nomenclatura" data-parsley-class-handler="#medidas">
                                </div>
                            </div>
                        </div>
                        </br>
...
<script>
    ...
    function crear(){
        ...
        var nomenclatura = $("#idnomenclatura").val();
        var form = $("#formCrear");
        if(activos){
            activos = 1;
        }
        ...
        if (va) {
            var settings = {
                "url": '<?php echo route('CauchoIndustrialCreateMedida')?>',
                "method": "POST",
                data: {
