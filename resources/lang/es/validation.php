...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'precio' => 'Precio de factura',
        'iva' => 'IVA',
        'monto_civa' => 'Monto con IVA',
        'rif' => 'RIF',
        'nombre_cliente' => 'Nombre del cliente',
        'direccion' => 'Direccion',
        'descripcion_solicitud' => 'Descripción de la Solicitud',

        'req_reparaciones' => 'Requisito de reparaciones',
        'req_danios' => 'Requisito de Daños',
        'req_banda' => 'Requisito de Banda',
        'req_etiqueta' => 'Requisito de Etiqueta',
        'req_dot_serial' => 'Requisito de DOT-Serial',
        'req_renovacion' => 'Requisito de Renovación',

        'foto_falla' => 'Imágen de la falla',
        'nombre_foto' => 'Nombre de la imágen',
        'descripcion_foto' => 'Descripción Falla',

        'tipo_vehiculo' => 'Tipo de Vehiculo',
        'marca_vehiculo' => 'Marca del Vehiculo',
        'modelo_vehiculo' => 'Modelo del Vehiculo',
        'carga_maxima' => 'Carga Máxima',
        'tipo_carga' => 'Tipo de Carga',
        'kilometraje' => 'Kilometraje',
        'ancho_rin' => 'Ancho de Rin',
        'psi' => 'PSI',

        'marca' => 'Marca de Caucho',
        'modelo' => 'Modelo de Caucho',
        'dot_serial' => 'Nro de DOT-Serial',
        'profundidad' => 'Profundidad',
        'boleta' => 'Boleta',
        'tipo_renovado' => 'Tipo de renovado',
        'serial_produccion' => 'Serial de Producción'
