                                  ...
                                  <div class="form-layout form-layout-1 p-2">
                                                                  ...
                                                                  <div class="form-group mg-b-10-force">
                                                                      <div class="row">
                                                                          ...
                                                                          <div class="col-sm-2"><label class="d-flex justify-content-center rdiobox rdiobox-primary">
                                                                                  <input type="radio" disabled name="req_dot_serial" id="no_{{$ReclamoCondicion->id}}" value="no" @if(!$ReclamoCondicion->activo) checked @endif><span>No</span></label>
                                          ...
                                          <div class="d-flex-column align-items-center justify-content-around ht-auto bd pd-x-20 pd-y-10">
				                            	<div class="pull-left text-left">
                                                    ...
                                                    <img src="<?php echo $reclamo->ImagenReclamoSucursal->imagen64 ?>" alt="" width="200px">
				                            	...
				                            	<div class="pull-left text-left">
                                                    ...
                                                    <h5 class="font-bold"> <span>{{$reclamo->InfoProductoSucursal->getProducto->descripcion}}</span></h5>
				                            			<p class="text-muted m-l-5">
                                                            ...
                                                            <b class="font-bold">Tipo de renovado:</b> {{$reclamo->InfoProductoSucursal->tipoRenovado}}
				                            				<br/>
                                                            @endif
                                                            ...
                                                            <b class="font-bold">Profundidad:</b> {{$reclamo->InfoProductoSucursal->Profundidad->descripcion}}
				                            				<br/>
                                                            @endif
				                            				...
				                            				<br/>
                                                            @endif
                                                            @if($reclamo->InfoProductoSucursal->getProducto->DatosCampos->marca)
                                  ...
                                  <div class="form-layout form-layout-1 p-2">
                                          ...
                                          <div class="d-flex-column align-items-center justify-content-around ht-auto bd pd-x-20 pd-y-10">
				                            	<div class="pull-left text-left">
				                            		<address>
                                                    <h4 class="tx-info">Imagen del Producto</h4>
                                                    <img src="<?php echo $reclamo->ImagenReclamo->imagen64 ?>" alt="" width="200px">
				                            	...
				                            	<div class="pull-left text-left">
                                                    ...
                                                    <h5 class="font-bold"> <span>{{$reclamo->InfoProductoAnalisis->getProducto->descripcion}}</span></h5>
				                            			<p class="text-muted m-l-5">
                                                            ...
                                                            <b class="font-bold">Tipo de renovado:</b> {{$reclamo->InfoProductoAnalisis->tipoRenovado}}
				                            				<br/>
                                                            @endif
                                                            ...
                                                            <b class="font-bold">Profundidad:</b> {{$reclamo->InfoProductoAnalisis->Profundidad->descripcion}}
				                            				<br/>
                                                            @endif
                                                            ...
                                                            @if($reclamo->InfoProductoAnalisis->getProducto->DatosCampos->lote_vulcanizacion )
                                                            <b class="font-bold">Lote vulcanización:</b> {{$reclamo->InfoProductoAnalisis->loteVulcanizacion}}
				                            				<br/>
                                                            @endif

                                                            @if($reclamo->InfoProductoAnalisis->getProducto->DatosCampos->lote_banda )
                                                            <b class="font-bold">Lote Banda:</b> {{$reclamo->InfoProductoAnalisis->loteBanda}}
				                            				<br/>
                                                            @endif
