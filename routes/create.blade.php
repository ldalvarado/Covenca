      ...
      $.ajax({
        ...
        success: function(data){
          ...
          $.ajax({
            ...
            'idProfundidad': document.getElementById('profundidadNeumatico').value,
      ...
      <div class="modal-footer">
        <div class="container">
          ...
          <div class="row justify-content-around">
              ...
              <div class="col-auto">
              <button id="button2" type="button" class="btn btn-danger" onclick="writeInDB(6,2,'No Procesado','La garantía no cumple las condiciones')" >Rechazar</button>
              </div>
